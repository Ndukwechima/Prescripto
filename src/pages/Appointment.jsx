    ...
    docInfo && (
      <div>
        ...
        <div className="sm:ml-72 sm:pl-4 font-medium text-gray-700 mt-4">
            ...
            {docSlots.length &&
              docSlots[slotIndex].map((item, index) => (
                <p
                  ...
                  className={`text-sm font-light flex-shrink-0 px-5 py-2 
          ...
          <button className="bg-(--primary-color) text-white text-sm font-light
          px-14 py-3 rounded-full mt-10">Book an appointment</button>
        </div>
